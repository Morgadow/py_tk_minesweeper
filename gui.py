...
class MinesweeperGUI(object):
    ...
    def build_gui(self):
        ...
        bot_gray_border = tk.Label(self._root, bg=COLOR_LIGHT_GRAY).place(x=LEFT_WHITE_BORDER + LEFT_GRAY_BORDER, y=self._size.height - BOTTOM_GRAY_BORDER, width=self._size.width - LEFT_GRAY_BORDER - LEFT_WHITE_BORDER - RIGHT_GRAY_BORDER, height=BOTTOM_GRAY_BORDER)
        ...
        outer_border_top = tk.Label(self._upper_frame, bg=COLOR_DARK_GRAY).place(x=0, y=0, width=self._upper_frame._width - OUTER_BORDER_TOP_FRAME, height=OUTER_BORDER_TOP_FRAME)
        outer_border_left = tk.Label(self._upper_frame, bg=COLOR_DARK_GRAY).place(x=0, y=OUTER_BORDER_TOP_FRAME*2, width=OUTER_BORDER_TOP_FRAME, height=self._upper_frame._height - OUTER_BORDER_TOP_FRAME*3)
        ...
        inner_border_top = tk.Label(self._upper_frame, bg=COLOR_DARK_GRAY).place(x=0, y=OUTER_BORDER_TOP_FRAME, width=self._upper_frame._width - OUTER_BORDER_TOP_FRAME*2, height=OUTER_BORDER_TOP_FRAME)
        inner_border_left = tk.Label(self._upper_frame, bg=COLOR_DARK_GRAY).place(x=OUTER_BORDER_TOP_FRAME, y=OUTER_BORDER_TOP_FRAME*2, width=OUTER_BORDER_TOP_FRAME, height=self._upper_frame._height - OUTER_BORDER_TOP_FRAME*4)
        inner_border_right = tk.Label(self._upper_frame, bg=COLOR_WHITE).place(x=self._upper_frame._width - OUTER_BORDER_TOP_FRAME*2, y=OUTER_BORDER_TOP_FRAME+INNER_BORDER_TOP_FRAME, width=OUTER_BORDER_TOP_FRAME, height=self._upper_frame._height - OUTER_BORDER_TOP_FRAME*2)
        inner_border_bottom = tk.Label(self._upper_frame, bg=COLOR_WHITE).place(x=OUTER_BORDER_TOP_FRAME*2, y=self._upper_frame._height-OUTER_BORDER_TOP_FRAME-INNER_BORDER_TOP_FRAME, width=self._upper_frame._width - OUTER_BORDER_TOP_FRAME*4, height=OUTER_BORDER_TOP_FRAME)
        ...
        top_2 = tk.Label(self._root, bg=COLOR_DARK_GRAY).place(x=LEFT_WHITE_BORDER + LEFT_GRAY_BORDER, y=TOP_WHITE_BORDER + TOP_GRAY_BORDER + FULL_HEIGHT_TOP_FRAME + BORDER_TOP_FIELD_BORDER + TOP_FIELD_BORDER_1, width=self._field_frame._width + LEFT_FIELD_BORDER + RIGHT_FIELD_BORDER_1, height=TOP_FIELD_BORDER_2)
        top_3 = tk.Label(self._root, bg=COLOR_DARK_GRAY).place(x=LEFT_WHITE_BORDER + LEFT_GRAY_BORDER, y=TOP_WHITE_BORDER + TOP_GRAY_BORDER + FULL_HEIGHT_TOP_FRAME + BORDER_TOP_FIELD_BORDER + TOP_FIELD_BORDER_1 + TOP_FIELD_BORDER_2, width=self._field_frame._width + LEFT_FIELD_BORDER, height=TOP_FIELD_BORDER_3)

        left_1 = tk.Label(self._root, bg=COLOR_DARK_GRAY).place(x=LEFT_WHITE_BORDER + LEFT_GRAY_BORDER, y=TOP_WHITE_BORDER + TOP_GRAY_BORDER + FULL_HEIGHT_TOP_FRAME + BORDER_TOP_FIELD_BORDER + TOP_FIELD_BORDER, width=LEFT_FIELD_BORDER_1, height=self._field_frame._height + BOT_FIELD_BORDER_3 + BOT_FIELD_BORDER_2)
        left_2 = tk.Label(self._root, bg=COLOR_DARK_GRAY).place(x=LEFT_WHITE_BORDER + LEFT_GRAY_BORDER + LEFT_FIELD_BORDER_1, y=TOP_WHITE_BORDER + TOP_GRAY_BORDER + FULL_HEIGHT_TOP_FRAME + BORDER_TOP_FIELD_BORDER + TOP_FIELD_BORDER, width=LEFT_FIELD_BORDER_2, height=self._field_frame._height + BOT_FIELD_BORDER_3)
        left_3 = tk.Label(self._root, bg=COLOR_DARK_GRAY).place(x=LEFT_WHITE_BORDER + LEFT_GRAY_BORDER + LEFT_FIELD_BORDER_1 + LEFT_FIELD_BORDER_2, y=TOP_WHITE_BORDER + TOP_GRAY_BORDER + FULL_HEIGHT_TOP_FRAME + BORDER_TOP_FIELD_BORDER + TOP_FIELD_BORDER, width=LEFT_FIELD_BORDER_3, height=self._field_frame._height)
        ...
        bot_1 = tk.Label(self._root, bg=COLOR_WHITE).place(x=LEFT_WHITE_BORDER + LEFT_GRAY_BORDER + LEFT_FIELD_BORDER, y=self._root._size.height - BOTTOM_GRAY_BORDER - BOT_FIELD_BORDER, width=self._field_frame._width + RIGHT_FIELD_BORDER, height=BOT_FIELD_BORDER_1)
        bot_2 = tk.Label(self._root, bg=COLOR_WHITE).place(x=LEFT_WHITE_BORDER + LEFT_GRAY_BORDER + LEFT_FIELD_BORDER_1 + LEFT_FIELD_BORDER_2, y=self._root._size.height - BOTTOM_GRAY_BORDER - BOT_FIELD_BORDER_3 - BOT_FIELD_BORDER_2, width=self._field_frame._width + RIGHT_FIELD_BORDER + LEFT_FIELD_BORDER_3, height=BOT_FIELD_BORDER_2)
